...
// methodization
    ...
    sealed class _OfZip3[T1, T2, T3](_this: Sequence[((T1, T2), T3)]) {
        def map3[R](f: (T1, T2, T3) => R = function.identity3[T1, T2, T3]): Reactive[R] = _this.asReactive.map{case ((v1, v2), v3) => f(v1, v2, v3)}
    }
    ...
    sealed class _OfZip4[T1, T2, T3, T4](_this: Sequence[(((T1, T2), T3), T4)]) {
        def map4[R](f: (T1, T2, T3, T4) => R = function.identity4[T1, T2, T3, T4]): Reactive[R] = _this.asReactive.map{case (((v1, v2), v3), v4) => f(v1, v2, v3, v4)}
    }
    ...
    sealed class _OfZip5[T1, T2, T3, T4, T5](_this: Sequence[((((T1, T2), T3), T4), T5)]) {
        def map5[R](f: (T1, T2, T3, T4, T5) => R = function.identity5[T1, T2, T3, T4, T5]): Reactive[R] = _this.asReactive.map{case ((((v1, v2), v3), v4), v5) => f(v1, v2, v3, v4, v5)}
    }
