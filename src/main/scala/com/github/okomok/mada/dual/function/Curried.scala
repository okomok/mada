...
final case class Curried2[f <: Function2](f: f) extends Function1 {
    ...
    override type self = Curried2[f]
    override  def apply[v1 <: Any](v1: v1): apply[v1] = Apply(v1)
    override type apply[v1 <: Any] = Apply[v1]

    final case class Apply[v1 <: Any](v1: v1) extends Function1 {
        override  val self = this
        override type self = Apply[v1]
