...
class CharFile private (val randomAccessFile: RandomAccessFile) extends Vector[Char] with Closeable {
...
class IntFile private (val randomAccessFile: RandomAccessFile) extends Vector[Int] with Closeable {
    def this(file: File, mode: String) = this(new RandomAccessFile(file, mode))
    def this(name: String, mode: String) = this(new RandomAccessFile(name, mode))
...
class LongFile private (val randomAccessFile: RandomAccessFile) extends Vector[Long] with Closeable {
    def this(file: File, mode: String) = this(new RandomAccessFile(file, mode))
    def this(name: String, mode: String) = this(new RandomAccessFile(name, mode))
