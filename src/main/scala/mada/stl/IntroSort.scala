...
private[mada] object IntroSort {
    ...
    def loop[A](* : Vector[A], __first: Int, last: Int, depth_limit: Int, __comp: Compare.Func[A]): Unit = {
        var __last = last
    ...
    def finalInsertionSort[A](* : Vector[A], __first: Int, __last: Int, __comp: Compare.Func[A]): Unit = {
