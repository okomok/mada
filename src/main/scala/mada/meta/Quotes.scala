...
trait Quotes { this: Meta.type =>
    ...
    trait quote0[R <: Object, f <: R] extends Function0 {
    ...
    trait quote1[T1 <: Object, R <: Object, f[_ <: T1] <: R] extends Function1 {
        override type isBind = `false`
    ...
    trait quote2[T1 <: Object, T2 <: Object, R <: Object, f[_ <: T1, _ <: T2] <: R] extends Function2 {
        override type isBind = `false`
    ...
    trait quote3[T1 <: Object, T2 <: Object, T3 <: Object, R <: Object, f[_ <: T1, _ <: T2, _ <: T3] <: R] extends Function3 {
        override type isBind = `false`
