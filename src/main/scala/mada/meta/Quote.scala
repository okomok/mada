 ...
 */
sealed abstract class quote0[f <: R, R] extends Function0 {
    override type Result0 = R

    override type apply0 = f
}

sealed abstract class quote1[f[_ <: T1] <: R, T1, R] extends Function1 {
...
sealed abstract class quote2[f[_ <: T1, _ <: T2] <: R, T1, T2, R] extends Function2 {
...
sealed abstract class quote3[f[_ <: T1, _ <: T2, _ <: T3] <: R, T1, T2, T3, R] extends Function3 {
