 ...
 */
sealed abstract class forwarding0[f <: Function0] extends Function0 {
    override type Result0 = f#Result0

    override type apply0 = f#apply0
}

sealed abstract class forwarding1[f <: Function1] extends Function1 {
...
sealed abstract class forwarding2[f <: Function2] extends Function2 {
...
sealed abstract class forwarding3[f <: Function3] extends Function3 {
