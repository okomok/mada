...
// methodization
    ...
    sealed class _Of1[a1](_self: a1 :: Nil) {
        def toTuple: Tuple1[a1] = Tuple1(_self.head)
    }
    implicit def _of1[a1](_self: a1 :: Nil): _Of1[a1] = new _Of1(_self)

    sealed class _Of2[a1, a2](_self: a1 :: a2 :: Nil) {
        def toTuple: Tuple2[a1, a2] = Tuple2(_self.head, _self.tail.head)
    }
    implicit def _of2[a1, a2](_self: a1 :: a2 :: Nil): _Of2[a1, a2] = new _Of2(_self)

    sealed class _Of3[a1, a2, a3](_self: a1 :: a2 :: a3 :: Nil) {
        def toTuple: Tuple3[a1, a2, a3] = Tuple3(_self.head, _self.tail.head, _self.tail.tail.head)
    }
    implicit def _of3[a1, a2, a3](_self: a1 :: a2 :: a3 :: Nil): _Of3[a1, a2, a3] = new _Of3(_self)

    sealed class _Of4[a1, a2, a3, a4](_self: a1 :: a2 :: a3 :: a4 :: Nil) {
        def toTuple: Tuple4[a1, a2, a3, a4] = Tuple4(_self.head, _self.tail.head, _self.tail.tail.head, _self.tail.tail.tail.head)
    }
    implicit def _of4[a1, a2, a3, a4](_self: a1 :: a2 :: a3 :: a4 :: Nil): _Of4[a1, a2, a3, a4] = new _Of4(_self)

    sealed class _Of5[a1, a2, a3, a4, a5](_self: a1 :: a2 :: a3 :: a4 :: a5 :: Nil) {
