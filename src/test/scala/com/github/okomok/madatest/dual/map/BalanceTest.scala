...
class BalanceTest extends junit.framework.TestCase {
    ...
    def testRotateLSingleL {
        ...
        type bm = map.bstree.Balance#apply[_3, _3, l, r, natOrd]
        val bm: bm = new map.bstree.Balance().apply(_3, _3, l, r, natOrd)
        meta.assertSame[node[_11, node[_3, t1, t2], t3], bm]
    ...
    def testRotateLDoubleL {
        ...
        type bm = map.bstree.Balance#apply[_3, _3, l, r, natOrd]
        val bm: bm = new map.bstree.Balance().apply(_3, _3, l, r, natOrd)
        meta.assertSame[node[_7, node[_3, t1, t2], node[_11, t3, t4]], bm]
