...
object Samples {
    ...
    type m6 =    map.bstree.Node[_3, _6, box[scala.Double], m4, m7, o]
    val m6: m6 = map.bstree.Node(_3, _6, box(3.4f), m4, m7, o)

    type m3 =    map.bstree.Node[_5, _3, box[scala.Boolean], m1, m6, o]
    val m3: m3 = map.bstree.Node(_5, _3, box(true), m1, m6, o)

    type m13 =    map_single[_13, box[scala.Char], o]
    val m13: m13 = map_single(_13, box('k'), o)

    type m14 =     map.bstree.Node[_2, _14, box[scala.Int], m13, map.bstree.Nil[o], o]
    val m14: m14 = map.bstree.Node(_2, _14, box(14), m13, map.bstree.Nil(o), o)

    type m10 =     map.bstree.Node[_3, _10, box[String], map.bstree.Nil[o], m14, o]
    val m10: m10 = map.bstree.Node(_3, _10, box("10"), map.bstree.Nil(o), m14, o)

    type m8 =    map.bstree.Node[_9, _8, box[scala.Boolean], m3, m10, o]
    val m8: m8 = map.bstree.Node(_9, _8, box(false), m3, m10, o)
