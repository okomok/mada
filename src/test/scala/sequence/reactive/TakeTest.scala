...
class TakeTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testThen: Unit = {
        val a = vector.Of(1,2,3,4,5,6)
        val b = new java.util.ArrayList[Int]
        reactive.from(a).take(3).onExit(_ =>b.add(99)).foreach(b.add(_))
    ...
    def testThen2: Unit = {
        val a = vector.Of(1,2,3,4,5,6)
        val b = new java.util.ArrayList[Int]
        reactive.from(a).take(3).onExit(_ =>b.add(98)).onExit(_ =>b.add(99)).foreach(b.add(_))
...
/*
    def testThenNotEnough: Unit = {
        ...
        val b = new java.util.ArrayList[Int]
        reactive.from(a).take(30).onExit(_ =>b.add(99)).foreach(b.add(_))
...
*/
    ...
    def testThenAppendThen: Unit = {
        val a = vector.Of(1,2,3,4,5)
        val b = new java.util.ArrayList[Int]
        (reactive.from(a).take(3) ++ reactive.Of(6,7,8)).onExit(_ =>b.add(99)).foreach(b.add(_))
