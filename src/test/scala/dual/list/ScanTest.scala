...
class ScanTest extends org.scalatest.junit.JUnit3Suite {
    ...
    case class Div() extends Function2 {
        ...
        override  def apply[x <: Any, y <: Any](x: x, y: y): apply[x, y] = x.asInstanceOfNat div y.asInstanceOfNat
        override type apply[x <: Any, y <: Any] = x#asInstanceOfNat#div[y#asInstanceOfNat]
    }
...
//        meta.assertSame[_15 :: _3 :: _1 :: Nil, u#force]
    ...
    def testLeftNil {
        ...
        type u = xs#scanLeft[_15, Div]
        val u: u = xs.scanLeft(_15, Div())
        meta.assertSame[_15 :: Nil, u#force]
    ...
    def testRight {
        ...
        meta.assertSame[_1 :: _6 :: _2 :: _2 :: Nil, u#force]
