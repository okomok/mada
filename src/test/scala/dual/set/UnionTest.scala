...
class UnionTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        meta.assertSame[`true`, set.sorted[nat.naturalOrdering]#add[_4]#add[_3]#add[_5]#add[_0]#add[_1]#add[_2]#equal[um]]
    ...
    def testEmpty2 {
        ...
        meta.assertSame[`true`,  set.sorted[nat.naturalOrdering]#add[_3]#add[_1]#add[_2]#equal[um]]
   ...
   def testLeftBiased {
        ...
        meta.assertSame[`true`,  set.sorted[nat.naturalOrdering]#add[_4]#add[_3]#add[_5]#add[_0]#add[_2]#equal[um]]
