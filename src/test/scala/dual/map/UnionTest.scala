...
class UnionTest extends org.scalatest.junit.JUnit3Suite {
    ...
    def testTrivial {
        ...
        meta.assertSame[`true`, map.sorted[nat.naturalOrdering]#put[_4, _5]#put[_3, _4]#put[_5, _6]#put[_0, _1]#put[_1, _2]#put[_2, _3]#equalWith[um, nat.naturalOrdering]]
    ...
    def testEmpty {
        ...
        meta.assertSame[map.sorted[nat.naturalOrdering], um]
    ...
    def testEmpty2 {
        ...
        meta.assertSame[`true`,  map.sorted[nat.naturalOrdering]#put[_3, _4]#put[_1, _2]#put[_2, _3]#equalWith[um, nat.naturalOrdering]]
   ...
   def testLeftBiased {
        ...
        meta.assertSame[`true`,  map.sorted[nat.naturalOrdering]#put[_4, _5]#put[_3, _4]#put[_5, _6]#put[_0, _1]#put[_2, _3]#equalWith[um, nat.naturalOrdering]]
