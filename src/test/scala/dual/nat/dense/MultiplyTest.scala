...
class MultiplyTest extends org.scalatest.junit.JUnit3Suite {
    ...
    trait teztTrivial {
        meta.assertSame[_6, _3 # times[ _2]]
        meta.assertSame[_6, _2 # times[ _3]]
        meta.assertSame[_0, _3 # times[ _0]]
        meta.assertSame[_0, _0 # times[ _0]]
        meta.assertSame[_0, _0 # times[ _9]]
        meta.assertSame[_12, _6 # times[ _2]]
        meta.assertSame[_15, _3 # times[ _5]]
        meta.assertSame[_8, _4 # times[ _2]]
        meta.assertSame[_1, _1 # times[ _1]]
        meta.assertSame[_9, _3 # times[ _3]]
    }
}
