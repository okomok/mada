...
package madatest; package sequencetest
...
class EqualsTest {
    ...
    def testEmpty: Unit = {
        val I1: Iterative[Int] = iterative.emptyOf[Int]
        val I2: Iterative[Int] = iterative.emptyOf[Int]
        val V1: Vector[Int] = vector.emptyOf[Int]
        val V2: Vector[Int] = vector.emptyOf[Int]
        val L1: List[Int] = list.emptyOf[Int]
        val L2: List[Int] = list.emptyOf[Int]
