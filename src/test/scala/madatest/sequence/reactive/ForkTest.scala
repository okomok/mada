...
class ForkTest {
    def testTrivial: Unit = {
        ...
        r.
            fork{r => r.subscribe(reactor.make(out.add(98), e => out.add(e *  2)))}.
            fork{r => ()}.
            fork{r => r.subscribe(reactor.make(out.add(99), e => out.add(e + 10)))}.
            fork{r => ()}.
            run
    ...
    def testTo: Unit = {
        ...
        val out = new java.util.ArrayList[Int]
        r.
            forkTo(reactor.make(out.add(98), e => out.add(e *  2))).
            forkTo(reactor.make(out.add(99), e => out.add(e + 10))).
            run
