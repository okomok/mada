...
class FolderTest {
    def testFolderLeft: Unit = {
        ...
        t.folderLeft(5)(_ + _).start(reactor.make(_ => s.add(99), s.add(_)))
    ...
    def testFolderEmpty: Unit = {
        val s = new java.util.ArrayList[Int]
        reactive.empty.of[Int].folderLeft(0)(_ + _).start(reactor.make(_ => s.add(99), s.add(_)))
    ...
    def testReducerLeft: Unit = {
        ...
        val u = vector.Of(5,6,8,11,15,20,26,33,41, 99)
        val s = new java.util.ArrayList[Int]
        t.reducerLeft(_ + _).start(reactor.make(_ => s.add(99), s.add(_)))
        assertEquals(u, vector.from(s))
    }
    ...
    def testReducerEmpty: Unit = {
        val s = new java.util.ArrayList[Int]
        reactive.empty.of[Int].reducerLeft(_ + _).start(reactor.make(_ => s.add(99), s.add(_)))
        assertEquals(vector.Of(99), vector.from(s))
    }
