...
class FlattenTest {
    ...
    def testFlatMap: Unit = {
        ...
        tr.flatMap{e => reactive.fromIterative(vector.range(0, e))}.start(reactor.make(_ => out.add(99), out.add(_)))
    ...
    def testUnsplit: Unit = {
        ...
        val out = new java.util.ArrayList[Int]
        rs.unsplit(sep).start(reactor.make(_ => out.add(99), out.add(_)))
