...
/*
    ...
    def testCycleEmpty: Unit = {
        val A1 = traversable.emptyOf[Int]
        val A2 = traversable.of(1,2,3)
...
*/
    def testTimes: Unit = {
        val A1 = traversable.of(1,6,7,10,14,17).times(3)
        assertEquals(A1, traversable.of(1,6,7,10,14,17,1,6,7,10,14,17,1,6,7,10,14,17))
        assertEquals(A1, traversable.of(1,6,7,10,14,17,1,6,7,10,14,17,1,6,7,10,14,17)) // run again.
    }
    ...
    def testSingle: Unit = {
        val A1 = traversable.single(9)
        val I1 = A1.cycle
        assertEquals(I1.take(3), traversable.of(9,9,9))
        assertEquals(I1.take(3), traversable.of(9,9,9))
        val I2 = A1.times(3)
        assertEquals(I2, traversable.of(9,9,9))
        assertEquals(I2, traversable.of(9,9,9))
    }
}
