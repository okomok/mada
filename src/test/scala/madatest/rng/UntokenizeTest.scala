...
class UntokenizeTest {
    ...
    def testTrivial {
        ...
        val actual = from(Array[Rng[Int]](r1, r2, r3, r4)).untokenize(sep, Traversal.RandomAccess).eval
    ...
    def testNontrivial {
        ...
        val r3 = from(Array(6, 4,23, 0,12,15)).eval
        val r4 = from(Array(11, 4)).eval
        val actual = from(Array[Rng[Int]](re, r1, re, re, re, r2, r3, re, r4, re)).untokenize(sep, Traversal.RandomAccess).eval
