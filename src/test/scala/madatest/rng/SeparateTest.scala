...
class SeparateTest {
    ...
    def testTrivial {
        ...
        val actual = from(Array[Rng[Int]](r1, r2, r3, r4)).separate(sep, BidirectionalTraversal).eval
    ...
    def testNontrivial {
        ...
        val r3 = from(Array(6, 4,23, 0,12,15)).eval
        val r4 = from(Array(11, 4)).eval
        val actual = from(Array[Rng[Int]](re, r1, re, re, re, r2, r3, re, r4, re)).separate(sep, BidirectionalTraversal).eval
    ...
    def testSinglePass {
        ...
        val r3 = from(Array(6, 4,23, 0,12,15)).eval
        val r4 = from(Array(11, 4)).eval
        val actual = from(Array[Rng[Int]](r1, r2, r3, r4)).separate(sep).eval
        detail.TestSinglePassReadOnly(Array(100,0,18,14,17,100,19,8,13,100,6,4,23,0,12,15,100,11,4), actual)
    }

    def testEmpty {
        detail.TestEmpty(from(Array[Rng[Int]]()).separate(sep).eval)
    }
}
